 ...
 */
public class IncrementalStateValidatorElasticBolt extends BaseElasticBolt {

    private int computationCostInNanaSeconds;
    private long progress = 0;
    private boolean acked;

    public IncrementalStateValidatorElasticBolt(int computationCostInNanaSeconds, boolean acked) {
