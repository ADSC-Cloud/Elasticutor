...
class Iface:
  ...
  def migrateTasks(self, targetHostName, taskId, routeNo):
    """
    Parameters:
     - targetHostName
     - executorId
  ...
  def getBucketDistributionString(self, taskid):
    """
    Parameters:
     - taskid
    """
  ...
  def getExecutorStatus(self, taskid):
    """
    Parameters:
     - taskid
    """
...
class Client(Iface):
  ...
  def send_migrateTasks(self, targetHostName, taskId, routeNo):
  ...
  def getBucketDistributionString(self, taskid):
    ...
    Parameters:
     - taskid
    """
    self.send_getBucketDistributionString(taskid)
    return self.recv_getBucketDistributionString()

  def send_getBucketDistributionString(self, taskid):
    self._oprot.writeMessageBegin('getBucketDistributionString', TMessageType.CALL, self._seqid)
    args = getBucketDistributionString_args()
    args.taskid = taskid
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getBucketDistributionString(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = getBucketDistributionString_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.tnee is not None:
      raise result.tnee
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getBucketDistributionString failed: unknown result")
  ...
  def getExecutorStatus(self, taskid):
    ...
    Parameters:
     - taskid
    """
    self.send_getExecutorStatus(taskid)
    return self.recv_getExecutorStatus()

  def send_getExecutorStatus(self, taskid):
    self._oprot.writeMessageBegin('getExecutorStatus', TMessageType.CALL, self._seqid)
    args = getExecutorStatus_args()
    args.taskid = taskid
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getExecutorStatus(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = getExecutorStatus_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.tnee is not None:
      raise result.tnee
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getExecutorStatus failed: unknown result")

  def queryClusterResource(self):
    self.send_queryClusterResource()
    return self.recv_queryClusterResource()

  def send_queryClusterResource(self):
    self._oprot.writeMessageBegin('queryClusterResource', TMessageType.CALL, self._seqid)
    args = queryClusterResource_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_queryClusterResource(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = queryClusterResource_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "queryClusterResource failed: unknown result")
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["getBucketDistributionString"] = Processor.process_getBucketDistributionString
    self._processMap["getExecutorStatus"] = Processor.process_getExecutorStatus
    self._processMap["queryClusterResource"] = Processor.process_queryClusterResource
  ...
  def process_migrateTasks(self, seqid, iprot, oprot):
    ...
    result = migrateTasks_result()
    try:
      self._handler.migrateTasks(args.targetHostName, args.taskId, args.routeNo)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
  ...
  def process_getBucketDistributionString(self, seqid, iprot, oprot):
    args = getBucketDistributionString_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getBucketDistributionString_result()
    try:
      result.success = self._handler.getBucketDistributionString(args.taskid)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except TaskNotExistException as tnee:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("getBucketDistributionString", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_getExecutorStatus(self, seqid, iprot, oprot):
    args = getExecutorStatus_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getExecutorStatus_result()
    try:
      result.success = self._handler.getExecutorStatus(args.taskid)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except TaskNotExistException as tnee:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("getExecutorStatus", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_queryClusterResource(self, seqid, iprot, oprot):
    args = queryClusterResource_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = queryClusterResource_result()
    try:
      result.success = self._handler.queryClusterResource()
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("queryClusterResource", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class migrateTasks_args:
  ...
  def __init__(self, targetHostName=None, taskId=None, routeNo=None,):
  ...
  def write(self, oprot):
    ...
    if self.targetHostName is not None:
      oprot.writeFieldBegin('targetHostName', TType.STRING, 1)
...
class getBucketDistributionString_args:
  """
  Attributes:
   - taskid
  """
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getBucketDistributionString_args')
    if self.taskid is not None:
      oprot.writeFieldBegin('taskid', TType.I32, 1)
      oprot.writeI32(self.taskid)
      oprot.writeFieldEnd()
...
class getBucketDistributionString_result:
  """
  Attributes:
   - success
   - tnee
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getBucketDistributionString_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRING, 0)
      oprot.writeString(self.success.encode('utf-8'))
      oprot.writeFieldEnd()
...
class getExecutorStatus_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getExecutorStatus_args')
    if self.taskid is not None:
      oprot.writeFieldBegin('taskid', TType.I32, 1)
      oprot.writeI32(self.taskid)
      oprot.writeFieldEnd()
...
class getExecutorStatus_result:
  """
  Attributes:
   - success
   - tnee
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getExecutorStatus_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRING, 0)
      oprot.writeString(self.success.encode('utf-8'))
      oprot.writeFieldEnd()
...
class queryClusterResource_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('queryClusterResource_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class queryClusterResource_result:
  """
  Attributes:
   - success
  """
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('queryClusterResource_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRING, 0)
      oprot.writeString(self.success.encode('utf-8'))
      oprot.writeFieldEnd()
